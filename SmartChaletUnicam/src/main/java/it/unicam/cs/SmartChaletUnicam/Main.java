...
public class Main {
    public static void main(String[] args) {
        /*
        AttivitaController attContr = new AttivitaController();
        attContr.visualizzaAttivita();
        attContr.prenotazioneAttivita("4316","628b875da5c17615bc2f4d1a");
        attContr.visualizzaAttivita();

        BarController barContr = new BarController();
